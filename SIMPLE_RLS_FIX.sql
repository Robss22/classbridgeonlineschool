-- SIMPLE RLS FIX FOR APPLICATIONS TABLE
-- This script creates the essential RLS policies to allow anonymous applications
...
-- Step 4: Test the fix with a simple insert (optional)
-- This will verify that anonymous users can now insert applications
-- INSERT INTO applications (first_name, last_name, gender, dob, nationality, curriculum, program_id, class, parent_name, parent_contact, parent_email, about_student, consent, document_url, status) VALUES ('Test', 'User', 'Male', '2000-01-01', 'Uganda', 'Test Curriculum', '00000000-0000-0000-0000-000000000000', 'S1', 'Test Parent', '123456789', 'test@test.com', 'Test description', true, 'https://test.com', 'pending');
