    ...
    return (
      <header className="bg-white shadow border-b">
        <div className="max-w-7xl mx-auto flex items-center justify-center px-4 py-3">
          <div className="animate-pulse text-gray-500">Loading teacher information...</div>
        </div>
      </header>
    );
  }
        ...
        <div className="flex flex-col flex-1 text-left gap-y-1">
          ...
          <div className="flex flex-row flex-wrap gap-x-8 gap-y-1 items-center text-xs sm:text-sm">
            <div className="text-gray-600 whitespace-nowrap">
              Role: <span className="font-semibold text-green-700">Teacher</span>
            </div>
            <div className="font-semibold whitespace-nowrap">
              Email: <span className="font-normal">{user.email || '-'}</span>
            </div>
            <div className="text-gray-600 whitespace-nowrap">
              Access Level: <span className="font-semibold text-blue-700">Subject Access</span>
            </div>
          </div>
        </div>
