...
export default function SubjectPageClient() {
  ...
  type TimetableRow = { timetable_id: string; day_of_week: string; start_time: string; end_time: string; meeting_link?: string | null };
  type LiveClassRow = { live_class_id: string; title: string; scheduled_date: string; start_time: string; end_time: string; meeting_link?: string | null };
