...
import { BookOpen, Calendar, User, Home, FileText, MessageCircle, Settings, ClipboardList, LogOut, X, Video } from 'lucide-react';
  ...
  return (
    <StudentProvider>
      <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col flex-1 min-h-screen overflow-hidden w-full">
          <div className="relative">
            <StudentTopBar isMobileMenuOpen={isMobileMenuOpen} onMobileMenuToggle={toggleMobileMenu} />
          </div>
