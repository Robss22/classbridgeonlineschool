    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">You must be an admin or teacher to view this page.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                {user.role === 'admin' ? 'Manage Assessments' : 'My Assessments'}
              </h1>
              <p className="mt-2 text-gray-600">
                {user.role === 'admin' 
                  ? 'Create and manage assessments for all programs and classes'
                  : 'Create and manage assessments for your assigned programs'
                }
              </p>
            </div>
            <button
