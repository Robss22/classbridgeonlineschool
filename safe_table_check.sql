-- Safe Table Check: No JOINs that might fail
...
-- 8. Check table constraints and foreign keys (separately for each table)
SELECT 
    tc.table_name, 
    tc.constraint_name, 
    tc.constraint_type,
...
-- 13. Check if there are any active user sessions
SELECT 
